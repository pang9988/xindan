<template>
  <div class="pr-header">
    <div style="margin-bottom:50px;" v-for="(item5,index) of p_list" :key="index">
      <div class="pr-head">
        <div class="pr-jin" style="position: fixed;width: 100%;background: #fff;z-index: 1;">
          ...
          <div>
            <img @click="$router.back(-1)" style="width:20px; margin-right:10px;" src="./../../assets/h.png" alt />
          </div>
        </div>
      </div>
      <div class="pr-min">
